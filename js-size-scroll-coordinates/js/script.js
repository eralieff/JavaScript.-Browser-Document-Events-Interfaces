...
const lessonItem = document.querySelector(".lesson__item");
const getLessonItemTopCoord = lessonItem.getBoundingClientRect().top;
const getLessonItemLeftCoord = lessonItem.getBoundingClientRect().left;
const getLessonItemTopDocumentCoord =
	getLessonItemTopCoord + window.pageYOffset;
const getLessonItemLeftDocumentCoord =
	getLessonItemLeftCoord + window.pageXOffset;
console.log(`x: ${getLessonItemLeftCoord}, y: ${getLessonItemTopCoord}`);
console.log(
	`x: ${getLessonItemLeftDocumentCoord}, y: ${getLessonItemTopDocumentCoord}`
);
