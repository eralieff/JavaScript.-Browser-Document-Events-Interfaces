...
const registrationForm = document.forms.registrationForm.elements;

const firstNameInput = registrationForm.firstName;
const lastNameInput = registrationForm.lastName;
const middleNameInput = registrationForm.middleName;
const genderSelect = registrationForm.gender;
const aboutMeTextarea = registrationForm.aboutMe;
const photoFile = registrationForm.photo;
const accountTypeRadio = registrationForm.accountType;
const emailInput = registrationForm.email;
const loginInput = registrationForm.login;
const passwordInput = registrationForm.password;
const confirmPasswordInput = registrationForm.confirmPassword;
const acceptTermsCheckbox = registrationForm.acceptTerms;

firstNameInput.addEventListener("input", counter);
lastNameInput.addEventListener("input", counter);
middleNameInput.addEventListener("input", counter);
aboutMeTextarea.addEventListener("input", counter);
emailInput.addEventListener("input", counter);
loginInput.addEventListener("input", counter);
passwordInput.addEventListener("input", counter);
confirmPasswordInput.addEventListener("input", counter);

function counter() {
	this.nextElementSibling.textContent = this.value.length;
}

aboutMeTextarea.addEventListener("paste", function (event) {
